...
<div class="row">
	...
	<div class="large-5 col">
		...
		<div class="in4">
		    <h2 class="woocommerce-order-in4__title">Thông tin người đặt hàng</h2>
		    
		    <table>
		        <?php if ( $order->get_billing_first_name() ) : ?>
		        <tr class="_dinhit-name">
		            <td>Họ và tên:</td>
